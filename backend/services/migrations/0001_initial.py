    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, default=None, upload_to='category/images/', verbose_name='Фото категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(blank=True, max_length=400, null=True, verbose_name='ссылка')),
                ('description', models.CharField(max_length=250, verbose_name='описание')),
                ('is_popular', models.BooleanField(default=False, verbose_name='Популярный сервис?')),
                ('icon_big', models.ImageField(blank=True, null=True, upload_to='services/images/big/', verbose_name='Фото сервиса большое')),
                ('icon_square', models.ImageField(blank=True, null=True, upload_to='services/images/square/', verbose_name='Фото сервиса')),
                ('icon_small', models.ImageField(blank=True, null=True, upload_to='services/images/small/', verbose_name='Фото сервиса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services_duration', models.CharField(choices=[('1', 'Один месяц'), ('3', 'Три месяца'), ('6', 'Шесть месяцев'), ('12', 'Один год')], default='1', max_length=20, verbose_name='длительность тарифа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tariff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='subscriptions', to='services.tarifflist')),
            ],
            options={
